...
<html>
<head>
  <stag:pageHead pageTitle="Create Form"/>
  <script type="text/javascript" src="/resources/js/components/FormQuestionsComponent.js"></script>
  <script type="text/javascript" src="/resources/js/services/createForm.js"></script>
          ...
          <div class="card-body">
            ...
            <div id="form-questions" style="display: none;">
              ...
              <table>
                <thead>
                <tr>
                  <th style="width: 88%;">Form Name</th>
                  <th>Actions</th>
                </tr>
                </thead>
                <tbody>
