...
<head>
  ...
  <script type="text/javascript" src="/resources/js/services/login.js"></script>
</head>
              ...
              <div class="card-body">
                ...
                <form id="loginForm" action="/action">
                  ...
                  <div class="form-group mt-4 mb-0">
                    ...
                    <div class="d-flex float-right px-0 py-2 small">
                      <a class="justify-content-end" href="forgot-password.jsp">Forgot Password?</a>
                    </div>
                  </div>
                </form>
              </div>
